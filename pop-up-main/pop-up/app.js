...
// var popupDiv = document.createElement("span");
// div.appendChild(popupDiv);
// popupDiv.setAttribute("class", "styleDiv"); 

var cancelButton = document.createElement("button");
var btnText = document.createTextNode("cancel")
cancelButton.setAttribute("class", "cut");
...
function details(el) {
    ...
    for (var key in usersList) {
        if (usersList[key].id === el) {
            ...
            modalBox.innerHTML = usersList[key].name + '\n' + usersList[key].username + '\n' + usersList[key].email
            + '\n' + usersList[key].address.street + '\n' + usersList[key].address.suite + '\n' 
            + usersList[key].address.city + '\n' + usersList[key].address.zipcode + '\n' + usersList[key].address.geo.lat 
            + '\n' + usersList[key].address.geo.lng + '\n' + usersList[key].phone + '\n' + usersList[key].website 
            + '\n' + usersList[key].company.name + '\n' + usersList[key].company.catchPhrase + '\n' 
            + usersList[key].company.bs;  
        }
    }
}
...
// var text = document.createTextNode(usersList[key].name + '\n' + usersList[key].username + '\n' + usersList[key].email + '\n' + usersList[key].address.street + '\n' + usersList[key].address.suite + '\n' + usersList[key].address.city + '\n' + usersList[key].address.zipcode + '\n' + usersList[key].address.geo.lat + '\n' + usersList[key].address.geo.lng + '\n' + usersList[key].phone + '\n' + usersList[key].website + '\n' + usersList[key].company.name + '\n' + usersList[key].company.catchPhrase + '\n' + usersList[key].company.bs);
// p.appendChild(text);
